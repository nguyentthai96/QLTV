Public Class frmSinhVien
    ...
    Private Function isEmpty() As Boolean
        Return (String.IsNullOrEmpty(txtmsv.Text) OrElse Not IsNumeric(txtmsv.Text) OrElse String.IsNullOrEmpty(txttsv.Text) OrElse (rdbtNam.Checked = False And rdbtNu.Checked = False) OrElse dtpkns.Value >= Date.Today OrElse String.IsNullOrEmpty(txtlop.Text) OrElse dtpkngaylamthe.Value >= Date.Today OrElse dtpkngayhethan.Value <= dtpkngaylamthe.Value)
    End Function
