Public Class frmLogin
    ...
    Private Sub btnLogin_Click(sender As Object, e As EventArgs) Handles btnLogin.Click
        ...
        If dtTable.Rows.Count > 0 Then
            ...
            maNV = _DBAccess.GetScalar(sqlQuery1)
            Me.Hide()
            frmMain.Show()
        Else
    ...
    Private Sub ckbhienmatkhau_CheckedChanged(sender As Object, e As EventArgs) Handles ckbhienmatkhau.CheckedChanged
        If ckbhienmatkhau.Checked = True Then
